...
class Agent():
    ...
    def learn(self, experiences, gamma):
        ...
        self.qnetwork_local.train()
        # extracting the action_value for the best action at time t + 1 from the target model
        best_action_q_value_target = self.qnetwork_target(next_states).gather(1, best_action_index.view(-1,1))
